...
# Set threshold for adaptation. AQI of 100, 150 corresponds to PM concentrations of 35.4 and 55.4 respectively.
pm_threshold = 35.4
if pm_threshold == 35.4:
    AQI_thresh = 100
elif pm_threshold == 55.4:
    AQI_thresh = 150
...
# # Output pickles 
# with open(outdir + 'adapt_ben_all_REF_2000_' + str(AQI_thresh), 'wb') as f:
#       cp.dump(adapt_ben,f)
# f.close()

# with open(outdir + 'adapt_ben_pc_all_REF_2000_' + str(AQI_thresh), 'wb') as f:
#       cp.dump(adapt_ben_pc,f)
# f.close()

# with open(outdir + 'adapt_cost_all_REF_2000_' + str(AQI_thresh), 'wb') as f:
#       cp.dump(adapt_cost,f)
# f.close()

# with open(outdir + 'adapt_cost_pc_all_REF_2000_' + str(AQI_thresh), 'wb') as f:
#       cp.dump(adapt_cost_pc,f)
# f.close()

# with open(outdir + 'adapt_count_all_REF_2000_' + str(AQI_thresh), 'wb') as f:
#       cp.dump(adapt_count,f)
# f.close()

# with open(outdir + 'adapt_util_all_REF_2000_' + str(AQI_thresh), 'wb') as f:
#       cp.dump(adapt_util,f)
# f.close()

# with open(outdir + 'adapt_util_pc_all_REF_2000_' + str(AQI_thresh), 'wb') as f:
#       cp.dump(adapt_util_pc,f)
# f.close()

# with open(outdir + 'PM_out_adapt_REF_2000_' + str(AQI_thresh), 'wb') as f:
#       cp.dump(pm_out_adapt,f)
# f.close()

# with open(outdir + 'PM_out_base_REF_2000_' + str(AQI_thresh), 'wb') as f:
