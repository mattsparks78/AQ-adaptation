...
cwage = pd.read_csv(r".\Data\county_wage.csv", dtype = 'object')

# Import county to grid conversion file
conv = pd.read_pickle(r'.\Data\county_population_per_cell')

# Import counties with correct names to add data to
cdata = pd.read_csv(r".\Data\county_pop.csv", dtype = 'object', encoding='latin-1')
...
AQgrid.to_file(r'.\Data\wage_per_grid.shp')        
AQgrid.to_csv(r'.\Data\wage_per_grid.csv')
