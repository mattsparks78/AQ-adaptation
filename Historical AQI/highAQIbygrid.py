...
aqi_15 = pd.read_csv(r".\Data\EPA County AQI\daily_aqi_by_county_2015.csv")
aqi_16 = pd.read_csv(r".\Data\EPA County AQI\daily_aqi_by_county_2016.csv")
aqi_17 = pd.read_csv(r".\Data\EPA County AQI\daily_aqi_by_county_2017.csv")
aqi_18 = pd.read_csv(r".\Data\EPA County AQI\daily_aqi_by_county_2018.csv")
aqi_19 = pd.read_csv(r".\Data\EPA County AQI\daily_aqi_by_county_2019.csv")
aqi_20 = pd.read_csv(r".\Data\EPA County AQI\daily_aqi_by_county_2020.csv")

# Import county to grid cell conversion df
ctg = pd.read_pickle(r".\Data\General\county_population_per_cell")

# Import base AQ grid to add columns to for each year
gbad = pd.read_pickle(r'.\Data\General\CAM_grid_pop')
