...
# # Output pickles
# with open(outdir + 'adapt_ben_all_P45_cost_cases' + str(inf_rate), 'wb') as f:
#     cp.dump(adapt_ben, f)
# f.close()

# with open(outdir + 'adapt_ben_pc_all_P45_cost_cases' + str(inf_rate), 'wb') as f:
#     cp.dump(adapt_ben_pc, f)
# f.close()

# with open(outdir + 'adapt_cost_all_P45_cost_cases' + str(inf_rate), 'wb') as f:
#     cp.dump(adapt_cost, f)
# f.close()

# with open(outdir + 'adapt_cost_pc_all_P45_cost_cases' + str(inf_rate), 'wb') as f:
#     cp.dump(adapt_cost_pc, f)
# f.close()

# with open(outdir + 'adapt_count_all_P45_cost_cases' + str(inf_rate), 'wb') as f:
#     cp.dump(adapt_count, f)
# f.close()

# with open(outdir + 'adapt_util_all_P45_cost_cases' + str(inf_rate), 'wb') as f:
#     cp.dump(adapt_util, f)
# f.close()

# with open(outdir + 'adapt_util_pc_all_P45_cost_cases' + str(inf_rate), 'wb') as f:
#     cp.dump(adapt_util_pc, f)
# f.close()

# with open(outdir + 'PM_out_base_P45_cost_cases' + str(inf_rate), 'wb') as f:
#     cp.dump(pm_out_base, f)
# f.close()

# with open(outdir + 'PM_out_adapt_P45_cost_cases' + str(inf_rate), 'wb') as f:
