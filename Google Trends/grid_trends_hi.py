...
# Create dataframe to temporarily hold trends data
    ...
    for dma in l:
        ...
        ar[dma+'_max_ratio_hi'] = (dma_trends[dma+'_max_ratio_hi'])*p
        ar['max_ratio_hi'] += ar[dma+'_max_ratio_hi']
        ar.drop(dma+'_max_ratio_hi', axis = 1, inplace = True)
    
    
    for d in list(ar['date']):
        AQgrid.loc[(AQgrid['ROW'] == r) & (AQgrid['COL'] == c), d] = ar.loc[ar['date'] == d, 'max_ratio_hi'].item()
 
# Output shapefile
AQgrid.to_file(driver = 'ESRI Shapefile', filename = r'C:\Users\User\OneDrive - University of Waterloo\Sparks\PNAS\WorkingFolder\Data\trends_cell_hi.shp')

# Test input pickle
test = gpd.read_file(r'C:\Users\User\OneDrive - University of Waterloo\Sparks\PNAS\WorkingFolder\Data\trends_cell_hi.shp')

# Output csv
AQgrid.to_csv(r'C:\Users\User\OneDrive - University of Waterloo\Sparks\PNAS\WorkingFolder\Data\trends_cell_hi.csv')
...
fig.savefig(r'C:\Users\User\OneDrive - University of Waterloo\Sparks\PNAS\WorkingFolder\Figures\Trends_hi_2017_01_22', dpi = 300)
