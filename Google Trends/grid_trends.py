...
# Create list of DMA regions included in cell    
    ...
    for dma in l:
        ...
        ar[dma+'_max_ratio'] = (dma_trends[dma+'_max_ratio'])*p
        ar['max_ratio'] += ar[dma+'_max_ratio']
        ar.drop(dma+'_max_ratio', axis = 1, inplace = True)
    
    
    for d in list(ar['date']):
        AQgrid.loc[(AQgrid['ROW'] == r) & (AQgrid['COL'] == c), d] = ar.loc[ar['date'] == d, 'max_ratio'].item()
 
# Output shapefile
AQgrid.to_file(driver = 'ESRI Shapefile', filename = r'C:\Users\User\OneDrive - University of Waterloo\Sparks\PNAS\WorkingFolder\Data\trends_cell_mid.shp')

# Test input pickle
test = gpd.read_file(r'C:\Users\User\OneDrive - University of Waterloo\Sparks\PNAS\WorkingFolder\Data\trends_cell_mid.shp')

# Output csv
AQgrid.to_csv(r'C:\Users\User\OneDrive - University of Waterloo\Sparks\PNAS\WorkingFolder\Data\trends_cell_mid.csv')
...
fig.savefig(r'C:\Users\User\OneDrive - University of Waterloo\Sparks\PNAS\WorkingFolder\Figures\Trends_2017_01_22', dpi = 300)
