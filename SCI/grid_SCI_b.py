...
# Load benmap grid
AQgrid = pd.read_csv(r'.\Data\BenMap Grid\BenMapGrid.csv')
...
counties_grid = pd.read_csv(r'.\Data\BenMap Grid\county_population_per_cell_b.csv', dtype = dtype_dict)
...
with open(r".\Data\BenMap Grid\ctc_sci", 'rb') as f:
     ctc_dict = cp.load(f)
f.close()        
...
# save sci_dict
with open(r".\Data\SCI\sci_tot_b", 'wb') as f:
      cp.dump(sci_dict,f)
f.close()
