            ...
            for year in [2050, 2100]:
                ...
                for policy in ['REF', 'P45', 'P37']:
                    ...
                    for IC in ['IC' + str(i) for i in range(1,6)]:
                        ...
                        outdir = r".\Data\Social Learning Model\Sep 150\\"
                        ...
                        for cell in alert_prop.keys():
                            for i in t_set:
                                ...
                                num_bad = len(year_pm[year_pm > 55.5])
                        ...
                        for cell in alert_prop.keys():
                            for i in t_set:
                                year_pm = pm_dict[str(cell)][i]
                                alert_days = year_pm[year_pm >= 55.5]
                                nonalert_days = year_pm[year_pm < 55.5]
...
# with open(outdir + 'net_ben_dict_sep_wage_reg_xi_150_1hr', 'wb') as f:
#     cp.dump(net_ben_dict,f)
#     f.close()                           
            
# with open(outdir + 'cost_dict_sep_wage_reg_xi_150_1hr', 'wb') as f:
#     cp.dump(cost_dict,f)
#     f.close()    

# with open(outdir + 'ben_dict_sep_wage_reg_xi_150_1hr', 'wb') as f:
#     cp.dump(ben_dict,f)
#     f.close()                 