...
counties_full = gpd.read_file(r".\Data\AQGrid\co99_d00.shp")
...
# Pickle harmonized
# harmonized.to_csv(r'.\Data\BenMap Grid\county_per_cell_b.csv', index = False)

# Test
# test = pd.read_pickle(r'.\Data\BenMap Grid\county_per_cell_b')
