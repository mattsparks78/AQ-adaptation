...
base_nat_2050_REF = np.sum(base_nat_2050_REF) * IF
base_nat_2100_REF = np.sum(base_nat_2100_REF) * IF
base_nat_2050_P45 = np.sum(base_nat_2050_P45) * IF
base_nat_2100_P45 = np.sum(base_nat_2100_P45) * IF
base_nat_2050_P37 = np.sum(base_nat_2050_P37) * IF
base_nat_2100_P37 = np.sum(base_nat_2100_P37) * IF

ad_nat_2050_REF = np.sum(ad_nat_2050_REF) * IF
ad_nat_2100_REF = np.sum(ad_nat_2100_REF) * IF
ad_nat_2050_P45 = np.sum(ad_nat_2050_P45) * IF
ad_nat_2100_P45 = np.sum(ad_nat_2100_P45) * IF
ad_nat_2050_P37 = np.sum(ad_nat_2050_P37) * IF
ad_nat_2100_P37 = np.sum(ad_nat_2100_P37) * IF   
...
for Pol in ['REF', 'P45', 'P37']:
    ...
    base_burden_tot_nat_2050[Pol] = np.sum(base_burden_tot_nat_2050[Pol]) * IF
    adapt_burden_tot_nat_2050[Pol] = np.sum(adapt_burden_tot_nat_2050[Pol]) * IF
...
for Pol in ['REF', 'P45', 'P37']:
    ...
    base_burden_pc_nat_2050[Pol] = np.sum(base_burden_pc_nat_2050[Pol])  * IF
    adapt_burden_pc_nat_2050[Pol] = np.sum(adapt_burden_pc_nat_2050[Pol])    * IF 
...
for Pol in ['REF', 'P45', 'P37']:
    ...
    base_burden_tot_nat_2100[Pol] = np.sum(base_burden_tot_nat_2100[Pol])  * IF
    adapt_burden_tot_nat_2100[Pol] = np.sum(adapt_burden_tot_nat_2100[Pol]) * IF
...
for Pol in ['REF', 'P45', 'P37']:
    ...
    base_burden_pc_nat_2100[Pol] = np.sum(base_burden_pc_nat_2100[Pol]) * IF
    adapt_burden_pc_nat_2100[Pol] = np.sum(adapt_burden_pc_nat_2100[Pol]) * IF
...
for r, c in rc:
    ...
    adapt_days_P45_2050_cell[(r, c)] = np.mean(adapt_days_P45_2050_cell[(r, c)])
    adapt_days_P37_2050_cell[(r, c)] = np.mean(adapt_days_P37_2050_cell[(r, c)])
