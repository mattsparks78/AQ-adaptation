...
with open(r"C:\Users\User\OneDrive - University of Waterloo\Sparks\PNAS\WorkingFolder\Data\SCI\sci_tot_b", 'rb') as f:
     sci_tot = cp.load(f)
f.close()

# Load population per celldata
grid_pop = pd.read_csv(r"C:\Users\User\OneDrive - University of Waterloo\Sparks\PNAS\WorkingFolder\Data\BenMap Grid\BenMapGridPop.csv")
...
with open(r'C:\Users\User\OneDrive - University of Waterloo\Sparks\PNAS\WorkingFolder\Data\SCI\sci_normalized_b', 'wb') as f:
     cp.dump(sci_norm,f)
f.close()
