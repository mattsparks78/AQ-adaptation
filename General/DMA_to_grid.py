...
with open(r"C:\Users\User\OneDrive - University of Waterloo\ClimatePenalty\WorkingFolder\Data\AQGrid\dma_full.json", 'rb') as f:
    dma_in = json.load(f)
...
# Pickle harmonized
harmonized.to_pickle(r'C:\Users\User\OneDrive - University of Waterloo\Sparks\PNAS\WorkingFolder\Data\dma_per_cell')

# Test
test = pd.read_pickle(r'C:\Users\User\OneDrive - University of Waterloo\Sparks\PNAS\WorkingFolder\Data\dma_per_cell')
