...
counties_grid = pd.read_csv(r'C:\Users\User\OneDrive - University of Waterloo\Sparks\PNAS\WorkingFolder\Data\BenMap Grid\county_per_cell_b.csv', dtype = 'object')
...
counties_pop = pd.read_csv(r"C:\Users\User\OneDrive - University of Waterloo\Sparks\PNAS\WorkingFolder\Data\General\county_pop.csv", dtype = 'object', encoding='latin-1')
...
# save counties_grid
counties_grid.to_pickle(r'C:\Users\User\OneDrive - University of Waterloo\Sparks\PNAS\WorkingFolder\Data\BenMap Grid\county_population_per_cell_b')
counties_grid.to_csv(r'C:\Users\User\OneDrive - University of Waterloo\Sparks\PNAS\WorkingFolder\Data\BenMap Grid\county_population_per_cell_b.csv', index = False)
